...
sourcebans.SetConfig("username", "user");            -- Database Login name
sourcebans.SetConfig("password", "pass");                -- Database Login Password
...
sourcebans.SetConfig("website", "www.example.com"); -- The URL where people can find your sourcebans install (Do not put http:// or the kick reason will break!)
